...
build/src_compute_SGComputeClient_cpp.o : src/compute/SGComputeClient.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_compute_SGComputeClient_cpp.o -c src/compute/SGComputeClient.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/src_compute_SGComputeResponser_cpp.o : src/compute/SGComputeResponser.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_compute_SGComputeResponser_cpp.o -c src/compute/SGComputeResponser.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/src_compute_SGComputeServer_cpp.o : src/compute/SGComputeServer.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_compute_SGComputeServer_cpp.o -c src/compute/SGComputeServer.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/src_compute_SGResponserExecutor_cpp.o : src/compute/SGResponserExecutor.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_compute_SGResponserExecutor_cpp.o -c src/compute/SGResponserExecutor.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/src_fs_SGFile_cpp.o : src/fs/SGFile.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_fs_SGFile_cpp.o -c src/fs/SGFile.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/src_SGBasicServer_cpp.o : src/SGBasicServer.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_SGBasicServer_cpp.o -c src/SGBasicServer.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/third_thread_MGPThread_cpp.o : third/thread/MGPThread.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/third_thread_MGPThread_cpp.o -c third/thread/MGPThread.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/third_thread_MGPThread_Linux_cpp.o : third/thread/MGPThread_Linux.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/third_thread_MGPThread_Linux_cpp.o -c third/thread/MGPThread_Linux.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/third_thread_MGPThreadPool_cpp.o : third/thread/MGPThreadPool.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/third_thread_MGPThreadPool_cpp.o -c third/thread/MGPThreadPool.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/src_compute_SGCompute_CS_pb-c_c.o : src/compute/SGCompute.CS.pb-c.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/src_compute_SGCompute_CS_pb-c_c.o -c src/compute/SGCompute.CS.pb-c.c -Iinclude -I../Renascence/include/ -Ithird
  
build/src_compute_SGCompute_SR_pb-c_c.o : src/compute/SGCompute.SR.pb-c.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/src_compute_SGCompute_SR_pb-c_c.o -c src/compute/SGCompute.SR.pb-c.c -Iinclude -I../Renascence/include/ -Ithird
  
build/third_protobuf-c_protobuf-c_c.o : third/protobuf-c/protobuf-c.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/third_protobuf-c_protobuf-c_c.o -c third/protobuf-c/protobuf-c.c -Iinclude -I../Renascence/include/ -Ithird
...
build/third_protobuf-c-rpc_protobuf-c-rpc-client_c.o : third/protobuf-c-rpc/protobuf-c-rpc-client.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/third_protobuf-c-rpc_protobuf-c-rpc-client_c.o -c third/protobuf-c-rpc/protobuf-c-rpc-client.c -Iinclude -I../Renascence/include/ -Ithird
...
build/third_protobuf-c-rpc_protobuf-c-rpc-data-buffer_c.o : third/protobuf-c-rpc/protobuf-c-rpc-data-buffer.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/third_protobuf-c-rpc_protobuf-c-rpc-data-buffer_c.o -c third/protobuf-c-rpc/protobuf-c-rpc-data-buffer.c -Iinclude -I../Renascence/include/ -Ithird
...
build/third_protobuf-c-rpc_protobuf-c-rpc-dispatch_c.o : third/protobuf-c-rpc/protobuf-c-rpc-dispatch.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/third_protobuf-c-rpc_protobuf-c-rpc-dispatch_c.o -c third/protobuf-c-rpc/protobuf-c-rpc-dispatch.c -Iinclude -I../Renascence/include/ -Ithird
...
build/third_protobuf-c-rpc_protobuf-c-rpc-server_c.o : third/protobuf-c-rpc/protobuf-c-rpc-server.c   ${ALL_INCLUESlibSunsetGlow.so}
	gcc -std=c11 -g -fPIC -o build/third_protobuf-c-rpc_protobuf-c-rpc-server_c.o -c third/protobuf-c-rpc/protobuf-c-rpc-server.c -Iinclude -I../Renascence/include/ -Ithird
  

ALL_INCLUESexample.out=

example.out:  build/simple_main_cpp.o libSunsetGlow.so
	g++ -std=c++11   build/simple_main_cpp.o -g -fPIC   ./libSunsetGlow.so -o example.out ${SELF_VARIABLES}
build/simple_main_cpp.o : simple_main.cpp libSunsetGlow.so  ${ALL_INCLUESexample.out}
	g++ -std=c++11 -g -fPIC -o build/simple_main_cpp.o -c simple_main.cpp -Iinclude -I../Renascence/include/ -Ithird
...
build/__compute-responser_cpp.o : ./compute-responser.cpp libSunsetGlow.so  ${ALL_INCLUEScompute-responser.out}
	g++ -std=c++11 -g -fPIC -o build/__compute-responser_cpp.o -c ./compute-responser.cpp -Iinclude -I../Renascence/include/ -Ithird
...
build/__compute-server_cpp.o : ./compute-server.cpp libSunsetGlow.so  ${ALL_INCLUEScompute-server.out}
	g++ -std=c++11 -g -fPIC -o build/__compute-server_cpp.o -c ./compute-server.cpp -Iinclude -I../Renascence/include/ -Ithird
...
test.out:  build/test_GPCreatorClientTest_cpp.o build/test_GPTest_cpp.o build/test_GPTestMain_cpp.o libSunsetGlow.so
	g++ -std=c++11   build/test_GPCreatorClientTest_cpp.o build/test_GPTest_cpp.o build/test_GPTestMain_cpp.o -g -fPIC   ./libSunsetGlow.so -lpthread -ldl -o test.out ${SELF_VARIABLES}
build/test_GPCreatorClientTest_cpp.o : test/GPCreatorClientTest.cpp libSunsetGlow.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPCreatorClientTest_cpp.o -c test/GPCreatorClientTest.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/test_GPTest_cpp.o : test/GPTest.cpp libSunsetGlow.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPTest_cpp.o -c test/GPTest.cpp -Iinclude -I../Renascence/include/ -Ithird
  
build/test_GPTestMain_cpp.o : test/GPTestMain.cpp libSunsetGlow.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -g -fPIC -o build/test_GPTestMain_cpp.o -c test/GPTestMain.cpp -Iinclude -I../Renascence/include/ -Ithird
