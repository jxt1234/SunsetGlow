...
ALL_INCLUESlibSunsetGlow.so= include//fs/SGFile.h include//pieces/SGCachePieces.h include//SGComputeClient.h include//SGComputeServer.h include//SGDebug.h include//SGParallelMachine.h include//fs/SGFile.h include//pieces/SGCachePieces.h include//SGComputeClient.h include//SGComputeServer.h include//SGDebug.h include//SGParallelMachine.h

libSunsetGlow.so:  build/src_compute_SGComputeClient_cpp.o build/src_compute_SGComputeServer_cpp.o build/src_compute_SGParallelMachine_cpp.o build/src_fs_SGFile_cpp.o build/src_pieces_SGCachePieces_cpp.o build/src_compute_SGCompute_CS_pb-c_c.o build/src_compute_SGCompute_SR_pb-c_c.o build/third_protobuf-c_protobuf-c_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-client_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-data-buffer_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-dispatch_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-server_c.o 
	g++ -std=c++11   build/src_compute_SGComputeClient_cpp.o build/src_compute_SGComputeServer_cpp.o build/src_compute_SGParallelMachine_cpp.o build/src_fs_SGFile_cpp.o build/src_pieces_SGCachePieces_cpp.o build/src_compute_SGCompute_CS_pb-c_c.o build/src_compute_SGCompute_SR_pb-c_c.o build/third_protobuf-c_protobuf-c_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-client_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-data-buffer_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-dispatch_c.o build/third_protobuf-c-rpc_protobuf-c-rpc-server_c.o -O3 -g -fPIC  --shared  ../Renascence/libGP.a -o libSunsetGlow.so ${SELF_VARIABLES}
...
build/src_compute_SGParallelMachine_cpp.o : src/compute/SGParallelMachine.cpp   ${ALL_INCLUESlibSunsetGlow.so}
...
compute-client.out:  build/__compute-client_cpp.o libSunsetGlow.so
	g++ -std=c++11   build/__compute-client_cpp.o -O3 -g -fPIC   ./libSunsetGlow.so -o compute-client.out ${SELF_VARIABLES}
...
ALL_INCLUEStest.out= include//fs/SGFile.h include//pieces/SGCachePieces.h include//SGComputeClient.h include//SGComputeServer.h include//SGDebug.h include//SGParallelMachine.h
