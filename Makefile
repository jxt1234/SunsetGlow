all:libSunsetGlow.so example.out compute-client.out compute-responser.out compute-server.out test.out 
...
build/src_pieces_SGCachePieces_cpp.o : src/pieces/SGCachePieces.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -g -fPIC -o build/src_pieces_SGCachePieces_cpp.o -c src/pieces/SGCachePieces.cpp -Iinclude -I../Renascence/include/ -Ithird
...
compute-client.out:  build/__compute-client_cpp.o libSunsetGlow.so
	g++ -std=c++11   build/__compute-client_cpp.o -g -fPIC   ./libSunsetGlow.so -o compute-client.out ${SELF_VARIABLES}
build/__compute-client_cpp.o : ./compute-client.cpp libSunsetGlow.so  ${ALL_INCLUEScompute-client.out}
	g++ -std=c++11 -g -fPIC -o build/__compute-client_cpp.o -c ./compute-client.cpp -Iinclude -I../Renascence/include/ -Ithird
