...
build/src_compute__SGHandler_cpp.o : src/compute//SGHandler.cpp   ${ALL_INCLUESlibSunsetGlow.so}
	g++ -std=c++11 -O3 -g -fPIC -o build/src_compute__SGHandler_cpp.o -c src/compute//SGHandler.cpp -Iinclude -I../Renascence/include/ -Ithird -I/Library/Java/JavaVirtualMachines/jdk1.8.0_40.jdk/Contents/Home/include/darwin/ -I/Library/Java/JavaVirtualMachines/jdk1.8.0_40.jdk/Contents/Home/include/ -Ithird/libhdfs/
