...
static const ProtobufCFieldDescriptor sgcompute__cs__piece_info__field_descriptors[2] =
{
  {
    "describe",
    1,
...
static const ProtobufCMethodDescriptor sgcompute__cs__compute_server__method_descriptors[1] =
{
